    ...
    const initialData = {
      reports: [
        {
          ...
          walletAddress: '0x5313936ab87ed60dc8a11a1a1a1a1a1a1a1a1a1',
        ...
        },
        {
          ...
          walletAddress: '0x8f2dc55eb87ed60dc8a11a1a1a1a1a1a1a1a1a1',
        ...
        },
        {
          ...
          walletAddress: '0x4313936ab87ed60dc8a11a1a1a1a1a1a1a1a1a2',
      ...
      campaigns: [
        ...
        },
        {
          ...
          walletAddress: '0x4313936ab87ed60dc8a11a1a1a1a1a1a1a2',
  ...
  try {
    ...
    if (!existing) {
      db.campaigns.unshift({
        ...
        walletAddress: report.walletAddress || '0x5313936ab87ed60dc8a11a1a1a1a1a1a1a1a1a1',
